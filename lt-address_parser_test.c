...
/* ./.libs/lt-address_parser_test.c - temporary wrapper executable for .libs/address_parser_test.exe
   Generated by libtool (GNU libtool) 2.4.6

   The address_parser_test program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "address_parser_test.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# address_parser_test - temporary wrapper script for .libs/address_parser_test.", f);
  fputs ("exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The address_parser_test program cannot be directly executed until all the lib", f);
  fputs ("tool\n", f);
  ...
  fputs ("    echo \"address_parser_test.exe:address_parser_test:$LINENO: libtool wrapper ", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"address_parser_test.exe:address_parser_test:$LINENO: newargv[$lt_dum", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"address_parser_test.exe:address_parser_test:$LINENO: newargv[0]:", f);
  ...
  fputs ("\n", f);
  fputs ("  program='address_parser_test.exe'\n", f);
