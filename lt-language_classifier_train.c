...
/* ./.libs/lt-language_classifier_train.c - temporary wrapper executable for .libs/language_classifier_train.exe
   Generated by libtool (GNU libtool) 2.4.6

   The language_classifier_train program cannot be directly executed until all the libtool
...
const char * EXE_PATH_VALUE   = "C:\\msys64\\usr\\local\\lib;C:\\msys64\\usr\\local\\bin;";
const char * TARGET_PROGRAM_NAME = "language_classifier_train.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# language_classifier_train - temporary wrapper script for .libs/language_class", f);
  fputs ("ifier_train.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The language_classifier_train program cannot be directly executed until all t", f);
  fputs ("he libtool\n", f);
  ...
  fputs ("    echo \"language_classifier_train.exe:language_classifier_train:$LINENO: libt", f);
  fputs ("ool wrapper (GNU libtool) 2.4.6\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"language_classifier_train.exe:language_classifier_train:$LINENO: new", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"language_classifier_train.exe:language_classifier_train:$LINENO:", f);
  ...
  fputs ("\n", f);
  fputs ("  program='language_classifier_train.exe'\n", f);
