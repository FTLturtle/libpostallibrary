...
/* ./.libs/lt-language_classifier_test.c - temporary wrapper executable for .libs/language_classifier_test.exe
   Generated by libtool (GNU libtool) 2.4.6

   The language_classifier_test program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "language_classifier_test.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# language_classifier_test - temporary wrapper script for .libs/language_classi", f);
  fputs ("fier_test.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The language_classifier_test program cannot be directly executed until all th", f);
  fputs ("e libtool\n", f);
  ...
  fputs ("    echo \"language_classifier_test.exe:language_classifier_test:$LINENO: libtoo", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"language_classifier_test.exe:language_classifier_test:$LINENO: newar", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"language_classifier_test.exe:language_classifier_test:$LINENO: n", f);
  ...
  fputs ("\n", f);
  fputs ("  program='language_classifier_test.exe'\n", f);
