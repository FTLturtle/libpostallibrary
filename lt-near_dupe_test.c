...
/* ./.libs/lt-near_dupe_test.c - temporary wrapper executable for .libs/near_dupe_test.exe
   Generated by libtool (GNU libtool) 2.4.6

   The near_dupe_test program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "near_dupe_test.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# near_dupe_test - temporary wrapper script for .libs/near_dupe_test.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The near_dupe_test program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("  notinst_deplibs=' libpostal.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("    echo \"near_dupe_test.exe:near_dupe_test:$LINENO: libtool wrapper (GNU libto", f);
  fputs ("ol) 2.4.6\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"near_dupe_test.exe:near_dupe_test:$LINENO: newargv[$lt_dump_args_N]:", f);
  fputs (" $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"near_dupe_test.exe:near_dupe_test:$LINENO: newargv[0]: $progdir/", f);
  fputs ("$program\" 1>&2\n", f);
  ...
  fputs ("\n", f);
  fputs ("  program='near_dupe_test.exe'\n", f);
