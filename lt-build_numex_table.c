...
/* ./.libs/lt-build_numex_table.c - temporary wrapper executable for .libs/build_numex_table.exe
   Generated by libtool (GNU libtool) 2.4.6

   The build_numex_table program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "build_numex_table.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# build_numex_table - temporary wrapper script for .libs/build_numex_table.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The build_numex_table program cannot be directly executed until all the libto", f);
  fputs ("ol\n", f);
  ...
  fputs ("    echo \"build_numex_table.exe:build_numex_table:$LINENO: libtool wrapper (GNU", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"build_numex_table.exe:build_numex_table:$LINENO: newargv[$lt_dump_ar", f);
  fputs ("gs_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"build_numex_table.exe:build_numex_table:$LINENO: newargv[0]: $pr", f);
  ...
  fputs ("\n", f);
  fputs ("  program='build_numex_table.exe'\n", f);
