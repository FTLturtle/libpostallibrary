...
/* ./.libs/lt-language_classifier.c - temporary wrapper executable for .libs/language_classifier.exe
   Generated by libtool (GNU libtool) 2.4.6

   The language_classifier program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "language_classifier.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# language_classifier - temporary wrapper script for .libs/language_classifier.", f);
  fputs ("exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The language_classifier program cannot be directly executed until all the lib", f);
  fputs ("tool\n", f);
  ...
  fputs ("    echo \"language_classifier.exe:language_classifier:$LINENO: libtool wrapper ", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"language_classifier.exe:language_classifier:$LINENO: newargv[$lt_dum", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"language_classifier.exe:language_classifier:$LINENO: newargv[0]:", f);
  ...
  fputs ("\n", f);
  fputs ("  program='language_classifier.exe'\n", f);
