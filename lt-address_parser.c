...
/* ./.libs/lt-address_parser.c - temporary wrapper executable for .libs/address_parser.exe
   Generated by libtool (GNU libtool) 2.4.6

   The address_parser program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "address_parser.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# address_parser - temporary wrapper script for .libs/address_parser.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The address_parser program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"address_parser.exe:address_parser:$LINENO: libtool wrapper (GNU libto", f);
  fputs ("ol) 2.4.6\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"address_parser.exe:address_parser:$LINENO: newargv[$lt_dump_args_N]:", f);
  fputs (" $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"address_parser.exe:address_parser:$LINENO: newargv[0]: $progdir/", f);
  fputs ("$program\" 1>&2\n", f);
  ...
  fputs ("\n", f);
  fputs ("  program='address_parser.exe'\n", f);
