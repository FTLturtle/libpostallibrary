...
/* ./.libs/lt-build_address_dictionary.c - temporary wrapper executable for .libs/build_address_dictionary.exe
   Generated by libtool (GNU libtool) 2.4.6

   The build_address_dictionary program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "build_address_dictionary.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# build_address_dictionary - temporary wrapper script for .libs/build_address_d", f);
  fputs ("ictionary.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The build_address_dictionary program cannot be directly executed until all th", f);
  fputs ("e libtool\n", f);
  ...
  fputs ("    echo \"build_address_dictionary.exe:build_address_dictionary:$LINENO: libtoo", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"build_address_dictionary.exe:build_address_dictionary:$LINENO: newar", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"build_address_dictionary.exe:build_address_dictionary:$LINENO: n", f);
  ...
  fputs ("\n", f);
  fputs ("  program='build_address_dictionary.exe'\n", f);
